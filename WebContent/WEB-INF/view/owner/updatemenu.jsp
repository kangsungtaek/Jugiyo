		...
		<div id="default" class="each">
			<div class="w3-half" style="padding-right: 10px; padding-top: 10px">
				<label>메뉴명</label> <input class="w3-input w3-border idx data"
					name="name" type="text" id="name" value="${menu.name }" />
					<span id="menuidx" class="idx2" style="font-size: 11px"> </span>
			</div>
			...
			<div class="w3-row">
				...
				<div class="w3-half">
					<div class="img_wrap">
						<img id="img" src="${pageContext.request.contextPath}${menu.fileUri}" class="w3-round" />
					</div>
				</div>
			</div>
		</div>
