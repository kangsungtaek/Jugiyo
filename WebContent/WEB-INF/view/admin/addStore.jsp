		...
		<form action="/admin/addStore" method="post" enctype="multipart/form-data" id="form1">
			...
			<div class="w3-row" style="height: 200px">
				<div class="w3-col w3-align-right" style="width: 200px">
					▶ <span>가게 이미지 | </span>  <input class="w3-input data"
							name="attach" type="file" id="ori"  required
							onchange="preview(this);"> 
				</div>
				<div class="w3-rest img_wrap">
			...
			<p>
				▶ <span>주 &nbsp;&nbsp;소 </span> &nbsp;| <input class="w3-input"
					...
					placeholder="배달받을 주소를 입력해주세요." onclick="sample4_execDaumPostcode()" />
			</p>
...
<script>
	...
	mapOption = {
		center : new daum.maps.LatLng(37.4965458, 127.02984130000004), // 지도의 중심좌표
		level : 3
	// 지도의 확대 레벨
	};
	//지도를 생성합니다    
	...
	//마커가 표시될 위치입니다 
	var markerPosition = new daum.maps.LatLng(37.4965458, 127.02984130000004);
